...
#' @name germinate
#' @title germinate
#' @usage Change life stage from seed to juvenile based on probability. New juveniles will have a size of 0.1.
#' @author Rose McKeon
#' @param pop a population dataframe as generated by populate_landscape(), ie: nested by plant.
...
germinate <- function(pop, prob = .5){
  ...
  # increase size of new juveniles so growth can work
  seeds <- pop %>% filter(
    life_stage == 0
  )
