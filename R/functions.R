#' @name disturb
#' @title disturb
#' @usage Causes mortality in a specific region of the landscape.
#' @author Rose McKeon
...
#' @name reproduce
#' @title reproduce
#' @usage Creates new seeds based on adult population.
#' @author Rose McKeon
...
#' @usage Filters a population dataframe by X and Y values within range of X and Y to give a subset of possible pollen donors for ovules that exist in X  and Y, based on pollen range and grid size (to account for landscape wrapping).
#' @author Rose McKeon
...
#' @name mutate_genome
#' @title mutate_genome
#' @usage Mutate allele values of genome based on mutaion rate.
#' @author Rose McKeon
...
#' @usage Chooses an allele, or N number of alleles from a locus.
#' @author Rose McKeon
...
#' @name create_ovules
#' @title create_ovules
#' @usage Adds a new list-column $ovules to an individual plant which contains ovules as parent IDs.
#' @author Rose McKeon
...
#' @name compete
#' @title compete
#' @usage Makes sure number of adults that survive in a cell to reproduce is constrained to K.
#' @author Rose McKeon
...
#' @name grow
#' @title grow
#' @usage Change size and number of plants based on growth rate determined via loci of genome.
#' @author Rose McKeon
...
#' @name germinate
#' @title germinate
#' @usage Changes some seeds within a dataframe into juveniles, based on the locations of adults as well as the probability of germination.
#' @author Rose McKeon
...
#' @name survive
#' @title survive
#' @usage Reduces population data based on probability of survival.
#' @author Rose McKeon
#' @param pop a population dataframe as generated by populate_landscape(), ie: nested by plant.
...
#' @name hard_select
#' @title hard_select
#' @usage hard selection based on trait values. Large trait values give higher survival probabilities.
#' @author Rose McKeon
...
#' @name move
#' @title move
#' @usage updates coordinate variables of a population dataframe as generated by populate_landscape(), ie: should be nested by plant. Movement has wrapping boundaries depending on grid size.
#' @author Rose McKeon
...
#' @usage Checks locations of individuals in start against those in finish. Returns finish split into those that did and did not match their original start positions.
#' @author Rose McKeon
...
#' @usage Checks locations of seeds against those of adults. Returns seeds split into those that could and could not germinate based on the presence of adults.
#' @author Rose McKeon
...
#' @usage Populates the landscape grid with seeds that have random genomes and random locations, by returning a filled population dataframe of said individuals.
#' @author Rose McKeon
...
#' @usage Groups population dataframe by coordinates X and Y and nests all other data in list-column $plants. Arranged by X and Y.
#' @author Rose McKeon
...
#' @name create_pop
#' @title create_pop
#' @usage Makes sure the population structure is always the same. Can be used to return an empty tibble (with no parameters supplied), or a generated population (if both parameters supplied).
#' @author Rose McKeon
...
#' @name create_genome
#' @title create_genome
#' @usage Creates diploid genomes using random numbers.
#' @author Rose McKeon
...
#' @name sample_genome
#' @title sample_genome
#' @usage Takes a vector of seed data that has parent IDs in the genome instead of alleles, and returns a genome of alleles which has been sampled from both parents.
#' @author Rose McKeon
